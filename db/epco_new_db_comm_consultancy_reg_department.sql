...
--
-- Dumping data for table `comm_consultancy_reg_department`
--

LOCK TABLES `comm_consultancy_reg_department` WRITE;
/*!40000 ALTER TABLE `comm_consultancy_reg_department` DISABLE KEYS */;
/*!40000 ALTER TABLE `comm_consultancy_reg_department` ENABLE KEYS */;
UNLOCK TABLES;

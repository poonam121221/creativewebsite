...
class Test extends Admin_Controller{
    ...
    public function index(){
        ...
        $this->data['DataList'] = $this->TestModel->getAllList($this->__table);     
        $this->front_view('admin/test/index',$this->data);
    ...
    public function add(){
        ...
        $countRec  = $this->TestModel->record_count($this->__table);
        if($countRec!=0){
        ...
        //$this->form_validation->set_rules('last_updated_on', 'Last Updated On', 'trim|required|check_date');        
                ...
                $this->__queryStatus = $this->TestModel->insertdata($this->__table,$DATAINPUT);
        ...
        $this->front_view('admin/test/add',$this->data);
    }//end add function
    ...
    public function edit(){
       ...
       // $this->load->library('form_validation');
        ...
        $this->data['DataList'] = $this->TestModel->getSingleList($this->__table,array('id'=>$this->__id));
       ...
       //   $this->form_validation->set_rules('last_updated_on', 'Last Updated On', 'trim|required|check_date');
                ...
                $this->__queryStatus = $this->TestModel->updatedata($this->__table,$DATAINPUT,array('id'=>$this->__id),$ACTIVITY_MSG);
                ...
                redirect('test/Test/edit/'.$this->__encId.'/');
        
        }//end check post method        
        
        $this->front_view('admin/test/edit',$this->data);
    }//end edit function
        ...
        public function remove(){
            ...
            $this->front_view('admin/test/clear',$this->data);
        }

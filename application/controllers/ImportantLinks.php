...
class ImportantLinks extends Frontend_Controller {
	...
	public function ajaxPaginationData(){
        ...
        $config['base_url']    = base_url()."ImportantLinks/ajaxPaginationData";
        ...
        //load the view
        $this->load->view('public/imp_link/ajax_imp_link', $this->data, false);

...
class Career extends Frontend_Controller {
	...
	public function index(){
		...
		$this->breadcrumbs->push($this->lang->line('career'), '/');
		$this->breadcrumbs->unshift($this->lang->line('home_page'), '/');
				
		$this->front_view('public/career/index',$this->data);
	}//end index function
	...
	public function ajaxPaginationData(){
        ...
        //total rows count
        $totalRec = count($this->CareerModel->getRows($conditions,$filter,$orderBy));
        
        //pagination configuration
        $config['target']      = '#ajaxdata';
        $config['base_url']    = base_url()."Career/ajaxPaginationData";
		...
		$this->data['archive_count'] = $this->CareerModel->record_count($this->__table,$archive_filter);
        
        //load the view
        $this->load->view('public/career/ajax_career', $this->data, false);
    ...
    public function archive(){
		...
		//Create dynamic Breadcrumbs
		$this->breadcrumbs->push($this->lang->line('career_archived'), '/');
		$this->breadcrumbs->unshift($this->lang->line('home_page'), '/');
		
		$this->front_view('public/career/archive',$this->data);
	...
	public function ajaxArchive(){
        ...
        //load the view
        $this->load->view('public/career/ajax_career_archive', $this->data, false);

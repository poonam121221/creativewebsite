...
class ImportantWebsites extends Frontend_Controller {
	...
	public function ajaxPaginationData(){
        ...
        $config['base_url']    = base_url()."ImportantWebsites/ajaxPaginationData";
        ...
        //load the view
        $this->load->view('public/imp_website/ajax_imp_web', $this->data, false);

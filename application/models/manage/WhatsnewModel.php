...
class WhatsnewModel extends MY_Model {
	...
	function getAllList($table, $filter=array(),$orderBy=array()){
		...
		if(trim($table) !="" && trim($table) !=null){
			$this->db->select('wn.*, concat(cm.admin_fname," ",cm.admin_lname) as admin_name, concat(cm1.admin_fname," ",cm1.admin_lname) as edited_name');

...
class Ajax_pagination{
    ...
    var $anchor_class    = '';
    var $show_count      = true;
    var $show_first_link = true;
    var $show_last_link  = true;
    var $show_digit_link = true;
    ...
    function create_links(){
        ...
        if  ($this->cur_page > $this->num_links && $this->show_first_link==TRUE){
        ...
        if (($this->cur_page + $this->num_links) < $num_pages && $this->show_last_link==TRUE){
        ...
        $output = "<div class='clearfix showing'>".$info."</div>".$this->full_tag_open.$output.$this->full_tag_close;

        return array('output'=>$output,'s_no'=>$this->s_no);
    }

...
<div class="inner-header">
    <div class="container">
        <h3><?php echo $this->lang->line('publication_archived'); ?></h3>
    </div>
</div>
...
function searchFilter(page_num,all) {
		...
		var dataString ={'page':page_num,'category_id':"<?php  if(!isset($category_id)) $category_id= ""; echo $category_id;?>",'sTitle':sTitle,"<?php echo $this->security->get_csrf_token_name();?>":tokenVal};
	    
	    $('#ajaxloading').modal('show');
	    
	    $.ajax({
	        type: 'POST',
	        url: '<?php echo base_url("Publication/ajaxArchive/"); ?>'+page_num,
	        data:dataString,

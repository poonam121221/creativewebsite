                ...
                <div class="col-md-8">
                    ...
                    <div class="innerpage-block">
                        <div class="table-filter">
							...
							<a  onclick="searchFilter(0,1);" name="search-all" id="search-all"> <i class="fa fa-refresh"></i></a>
...
<script type="text/javascript">
	...
	function searchFilter(page_num,all) {
		...
		var dataString ={'page':page_num,'sTitle':sTitle,"<?php echo $this->security->get_csrf_token_name();?>":tokenVal,'category_id':category_id};

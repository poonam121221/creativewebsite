    ...
    <div class="inner-content py-3">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="innertitle">
                        <p class="float-left"><?php echo $this->lang->line('notice_board_archived'); ?></p>
			...
			<?php echo $this->lang->line('reset'); ?></button>
                    ...
                    <span><?php echo isset($LastUpdatedDate) ? $this->lang->line('last_updated') . ':' . $LastUpdatedDate : ''; ?></span>
                </div>
            </div>
        </div>
    </div>
...
function searchFilter(page_num,all) {
	    ...
	    $.ajax({
	        type: 'POST',
	        url: '<?php echo base_url("NoticeBoard/ajaxArchive/"); ?>'+page_num,
	        data:dataString,

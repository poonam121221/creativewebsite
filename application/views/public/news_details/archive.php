...
<div class="inner-header">
    <div class="container">
        <h3><?php echo $this->lang->line('news_archived'); ?></h3>
    </div>
</div>
...
function searchFilter(page_num,all) {
		...
		var dataString ={'page':page_num, 'type': <?php echo $type; ?>,'sTitle':sTitle,"<?php echo $this->security->get_csrf_token_name();?>":tokenVal};
	    
	    showLoader();
	    
	    $.ajax({
	        type: 'POST',
	        url: '<?php echo base_url("NewsDetails/ajaxArchive/"); ?>'+page_num,
	        data:dataString,

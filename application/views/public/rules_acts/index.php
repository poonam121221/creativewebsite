            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="detail">
                        ...
                        <?php echo getImpLinks(8); ?>
                    </div>
                </div>
                <div class="col-md-9">
                    <div class="innertitle">
                        <p class="float-left"><?php echo $this->lang->line('rules_acts'); ?></p>
...
function searchFilter(page_num,all) {
		...
		var dataString ={'page':page_num,'sTitle':sTitle,"<?php echo $this->security->get_csrf_token_name();?>":tokenVal,'cid':cid};
	    
	    $('#ajaxloading').modal('show');
	    
	    $.ajax({
	        type: 'POST',
	        url: '<?php echo base_url("RulesActs/ajaxPaginationData/"); ?>'+page_num,
	        data:dataString,

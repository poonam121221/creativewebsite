...
<div class="inner-header">
    <div class="container">
        <h3><?php echo $this->lang->line('useful_links'); ?></h3>
    </div>
</div>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <div class="innerpage-block">
                        <div class="pagedetail" id="print">
                            <div class="row searchtop">
                                <div class="col-sm-4 mb-2">
                                    <input type="text" name="title" value="" id="sTitle" class="form-control"
                                ...
                                <div class="col-sm-4 mb-2">
                                    ...
                                    <button class="btn btn-danger" onclick="searchFilter(0,1);" name="search-all"
                                        id="search-all">
...
function searchFilter(page_num, all) {
    ...
    $.ajax({
        type: 'POST',
        url: '<?php echo base_url("ImportantLinks/ajaxPaginationData/"); ?>' + page_num,
        data: dataString,

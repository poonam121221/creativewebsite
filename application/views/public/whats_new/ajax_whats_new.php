 ...
 <div class="table-responsive tbl_style wrapper">
 <table class="table table-bordered table-hover" id="acrylic">
	...
	<tr>
		...
		<a target="_blank" href="<?php echo html_escape($row->attachment); ?>"><i class="fa fa-download"></i></a>
		<?php endif; ?>
		</td>
   </tr>
	<?php 
...
<div class="row">
	<div class="col-sm-12">
		<a class="nounderline" href="<?php echo base_url('whats-new/archive/'); ?>">

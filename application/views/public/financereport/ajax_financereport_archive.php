 ...
 <table class="table table-striped table-bordered table-hover">
		...
		<tr>
			...
			<th width="85%"><?php echo $this->lang->line('financial_year'); ?></th>
			<th width="10%" class="text-center"><?php echo $this->lang->line('financereport_archived'); ?></th>
		</tr>
		</thead>
		<tbody> 
	<?php 
...
<div class="row">
	<div class="col-sm-12">
		<a class="btn btn-primary" href="<?php echo base_url('financereport'); ?>">

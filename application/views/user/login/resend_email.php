...
<div class="page_title">
 <div class="h2 title_text"><?php echo $this->lang->line('resend_email'); ?></div>
...
<div class="row brand">
  ...
  <div class="logintext">Resend Email (User)</div>         
  </div>
</div><!--End brand-->
...
<?php
	$atributes = array('id'=>'frmResendEmail', 'autocomplete'=>'off');
	echo form_open('user/resend-email',$atributes);
...
<div class="col-md-6">
 <div class="input-error">
  <input type="text" class="form-control" placeholder="Secutity Code" name="captcha" tabindex="3" />
  </div>
</div>
</div>
<hr />

...
<div class="portlet-title">
  <div class="caption">Add Website Setting</div>
...
echo form_open('test/Test/add',$atr2); 
?>
 <div class="form-body">
 
 	<div class="form-group clearfix">
		<label class="col-lg-2 col-md-3 control-label">Name <span class="red">*</span></label>
		<div class="col-lg-5 col-md-6">
		<?php $f1 = array('name'=>'name','id'=>'name','class'=>'form-control');
		echo form_input($f1);
	    ?>
		</div>
	</div><!--End form-group-->
	<div class="form-group clearfix">
		<label class="col-lg-2 col-md-3 control-label">Purpose <span class="red">*</span></label>
		<div class="col-lg-5 col-md-6">
		<?php $f2 = array('name'=>'purpose','id'=>'purpose','class'=>'form-control');
		echo form_input($f2);
	    ?>
		</div>
	</div><!--End form-group-->

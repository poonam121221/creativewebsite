...
<div class="portlet-title">
  <div class="caption">Add Accesslist</div>
...
echo form_open_multipart('manage/Accesslist/add',$atr2); 
?>
 <div class="form-body">
 	...
 	<div class="form-group">
		...
		<div class="col-sm-12">
		<?php $TITLE = array( 
        'name'=>'controller_title','id'=>'controller_title','class'=> 'form-control','placeholder'=>'Enter Title');
 	...
 	<div class="form-group">
		...
		<div class="col-sm-12">
		<?php 
		echo form_dropdown(array('name'=>'menu_id','id'=>'menu_id','class'=>'form-control text-lower'),
		isset($ControllerList)?$ControllerList:array(''=>'--SELECT CATEGORY--'),isset($DataList->menu_id) ? ($DataList->menu_id):'');
		?>
		</div>
	</div><!--End form-group-->
 	...
 	<div class="form-group">
        ...
        'name'=>'function_name','id'=>'function_name','class'=> 'form-control','placeholder'=>'Enter function Name');

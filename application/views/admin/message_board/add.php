	...
	<div class="col-md-12">
		...
		<div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption">Add Message Board</div>
			...
			<div class="portlet-body">
				...
				echo form_open_multipart('manage/Messageboard/add', $atr2);
				?>
				<div class="form-body">

					<div class="form-group">
						<label class="col-sm-3 control-label">Name (Hindi) <span class="red">*</span></label>
						<div class="col-sm-9">
							<?php $TITLE_HI = array(
					...
					<div class="form-group">
						<label class="col-sm-3 control-label">Name (English) <span class="red">*</span></label>
						<div class="col-sm-9">
							<?php $TITLE_EN = array(
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<?php $heading_hi = array(
								'name' => 'heading_hi', 'id' => 'heading_hi', 'class' => 'form-control', 'placeholder' => 'Heading in hindi'
							);
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<?php $heading_en = array(
								'name' => 'heading_en', 'id' => 'heading_en', 'class' => 'form-control', 'placeholder' => 'Heading in english'
							);
					...
					<div class="form-group">
						<label class="col-sm-3 control-label">Message (Hindi) <span class="red">*</span></label>
						<div class="col-sm-9">
							<?php $MSG_HI = array(
								'name'          => 'message_hi',
								'id'            => 'message_hi',
					...
					<div class="form-group">
						<label class="col-sm-3 control-label">Message (English) <span class="red">*</span></label>
						<div class="col-sm-9">
							<?php $MSG_EN = array(
								'name'          => 'message_en',
								'id'            => 'message_en',

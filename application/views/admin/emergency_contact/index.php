	...
	<div class="panel-body">
	  ...
	  <div class="row">
		...
		//echo form_input($TITLE);
                echo form_dropdown('district', $district, (isset($DataList->is_alert) && $DataList->is_alert !='' )?
         html_escape($DataList->is_alert):set_value('is_alert'),array('class'=> 'form-control input-medium','id'=>'sDistrict'));
	    ?>
	  	</div>
		<div class="col-sm-3 ">
...
<div class="portlet-title">
  <div class="caption">Emergency Contact List</div>
...
function searchFilter(page_num,all) {
	    ...
	    var tokenVal  =  $(document).find('#sysToken').val();
	        ...
	        sStatus = $("#sStatus option:selected").val(); 
                sDistrict = $("#sDistrict option:selected").val();
	    
	    var dataString ={'page':page_num,'sTitle':sTitle,'sStatus':sStatus,'sDistrict':sDistrict,
	    ...
	    $.ajax({
	        type: 'POST',
	        url: '<?php echo base_url("manage/EmergencyContact/ajaxPaginationData/"); ?>'+page_num,
	        data:dataString,

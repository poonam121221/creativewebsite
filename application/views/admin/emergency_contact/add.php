...
<div class="portlet-title">
  <div class="caption">Add Emergency Contact</div>
  <div class="tools"> <a href="javascript:;" class="collapse"> </a></div>
</div><!--End portlet-title-->
<div class="portlet-body">

	<?php
	    $hidden = array('id' => html_escape(isset($DataList->contact_id)?$DataList->contact_id:''));
		$atr2 =array('id'=>'frmEmergencyContact','name'=>'frmEmergencyContact','role'=>'form', 'autocomplete'=>'off');
   		echo form_open_multipart('manage/EmergencyContact/add',$atr2,$hidden); 
	?>
     ...
     <?php 
		echo form_dropdown('contact_district', $district, (isset($DataList->contact_district) && $DataList->contact_district !='' )?
         html_escape($DataList->contact_district):set_value('contact_district'),array('class'=> 'form-control'));
	 ?>
     </div>
     </div><!--End Form-group-->

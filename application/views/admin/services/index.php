...
<div class="col-md-12">
	<ul class="page-breadcrumb breadcrumb">
		...
		<ul class="dropdown-menu pull-right" role="menu">
		 <li><a href="<?php echo base_url('manage/Services/add'); ?>"><i class="fa fa-plus"></i> Add</a></li>
		</ul>
		</li>
	</ul>
...
<div class="portlet-title">
  <div class="caption">Services List</div>
...
function searchFilter(page_num,all) {
	    ...
	    $.ajax({
	        type: 'POST',
	        url: '<?php echo base_url("manage/Services/ajaxPaginationData/"); ?>'+page_num,
	        data:dataString,

...
<div class="portlet-title">
  <div class="caption">Circular List (Recycle)</div>
...
function searchFilter(page_num) {
	    ...
	    var dataString ={'page':page_num,'sTitle':sTitle,'sStatus':sStatus,'sortBy':sortBy,
	    ...
	    $.ajax({
	        type: 'POST',
	        url: '<?php echo base_url("manage/Circular/ajaxPaginationRecycle/"); ?>'+page_num,
	        data:dataString,

...
<div class="panel panel-primary">
	...
	<div class="panel-body">
	  ...
	  <div class="row">
	   <div class="col-sm-3">
		<?php
		echo form_dropdown(array('name'=>'category','id'=>'c_id','class'=>'form-control select2me'),
		isset($CategoryList)?$CategoryList:array(''=>'--SELECT DEPARTMENT--'),isset($DataList->dept_id) ? ($DataList->dept_id):'');
		?>
		</div>
	  	<div class="col-sm-3">
...
<div class="portlet-title">
  <div class="caption">Circular List</div>
...
function searchFilter(page_num,all) {
	    ...
	    $.ajax({
	        type: 'POST',
	        url: '<?php echo base_url("manage/Circular/ajaxPaginationData/"); ?>'+page_num,
	        data:dataString,

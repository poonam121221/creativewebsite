...
<div class="portlet-title">
  <div class="caption">Edit News</div>
...
<div class="portlet-body">
	...
	<?php 
		...
		$atr2 =array('id'=>'frmNews','name'=>'frmNews','role'=>'form', 'autocomplete'=>'off');
   		echo form_open_multipart('manage/News/edit',$atr2,$hidden); 
	?>
     ...
     <div class="form-group clearfix">
		<label class="col-lg-2 col-sm-3 control-label">Attachment </label>
	 ...
	 <div class="form-group clearfix">
		...
		<div class="col-lg-10 col-md-9">
		<?php 
		$archive_date= get_date($DataList->archive_exp_date);
		$ARCHIVE_DATE = array('name'=>'archive_date','id'=>'archive_date','class'=>'form-control','value'=>(isset($DataList->archive_exp_date) && !empty($archive_date))? get_date($DataList->archive_exp_date):"");

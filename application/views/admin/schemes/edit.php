...
<div class="portlet-title">
  <div class="caption">Edit Schemes</div>
...
echo form_open_multipart('manage/Schemes/edit',$atr2,$hidden); 
?>
 <div class="form-body">
	 ...
	 <div id="description_en1"></div>
	   ...
	   <div class="form-group clearfix">
		...
		<div class="col-md-10 col-sm-9">
		<?php $ARCHIVE_DATE = array('name'=>'archive_date','id'=>'archive_date','class'=>'form-control input-medium','value'=>(isset($DataList->archive_exp_date) && !empty(get_date($DataList->archive_exp_date)))? get_date($DataList->archive_exp_date):"");
 	 ...
 	 <div class="form-group">
		...
		<div class="col-md-10 col-sm-9">
			...
			<a class="btn purple" href="<?php echo base_url('manage/Schemes/'); ?>">Back</a>
		</div>
	</div><!--End form-group-->

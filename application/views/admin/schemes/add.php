...
<div class="portlet-title">
  <div class="caption">Add Schemes</div>
...
<?php
$atr2 =array('id'=>'frmSchemes','name'=>'frmSchemes','class'=>'form-horizontal','role'=>'form', 'autocomplete'=>'off');
echo form_open_multipart('manage/Schemes/add',$atr2); 
?>
 <div class="form-body">

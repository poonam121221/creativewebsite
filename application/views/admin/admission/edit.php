...
<div class="col-md-12">
	<ul class="page-breadcrumb breadcrumb">
		...
		<li><a href="<?php echo base_url('manage/Circular/'); ?>">View</a></li>
	</ul>
...
<div class="portlet-title">
  <div class="caption">Edit Circular</div>
...
echo form_open_multipart('manage/Circular/edit',$atr2,$hidden); 
?>
 <div class="form-body">
...
<script type="text/javascript">
	...
	$('#archive_date').datepicker({format:'dd-mm-yyyy',autoclose: true,startDate:'-1m'}).on('changeDate', function(ev) {

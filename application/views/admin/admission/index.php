...
<div class="row">
    <div class="col-md-12">
		...
		<li><a href="<?php //echo base_url('manage/Circular/add'); 
    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-sm-6">
                        <?php  $TITLE = array('name'=>'title','id'=>'sTitle','class'=> 'form-control','placeholder'=>'Search by Name,Email or Enrollment no');
						echo form_input($TITLE);
						?>
                    </div>
                    <div class="col-sm-6">
                        <button class="btn green" onclick="searchFilter();" name="search" id="search"><i
        ...
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption">Admission List</div>
...
function searchFilter(page_num, all) {
    ...
    $.ajax({
        type: 'POST',
        url: '<?php echo base_url("manage/Admission/ajaxPaginationData/"); ?>' + page_num,
        data: dataString,

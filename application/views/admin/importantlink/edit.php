...
<div class="portlet-title">
  <div class="caption">Edit Important Links</div>
...
$atr2 =array('id'=>'frmImportantlink','name'=>'frmImportantlink','class'=>'form-horizontal','role'=>'form', 'autocomplete'=>'off');
echo form_open_multipart('manage/Importantlink/edit',$atr2,$hidden); 
?>
 <div class="form-body">
        ...
        'value' => (isset($DataList->title_hi) && $DataList->title_hi !='' )?
         html_escape(stripslashes2($DataList->title_hi)):"");
	   ...
	   <div class="form-group">
        ...
        'value' => (isset($DataList->title_en) && $DataList->title_en !='' )?
         html_escape(stripslashes2($DataList->title_en)):"");
 	 ...
 	 <div class="form-group">
		...
		<div class="col-sm-9">
			...
			<a class="btn purple" href="<?php echo base_url('manage/Importantlink/'); ?>">Back</a>
		</div>
	</div><!--End form-group-->
...
<script type="text/javascript">
	...
	jQuery( "#frmImportantlink" ).validate({
		  rules: {
		  title_hi: {
		        required: true,
		        minlength:2,

...
<div class="portlet-title">
  <div class="caption">Add Landing Page</div>
...
<?php
$atr2 =array('id'=>'frmLandingpage','name'=>'frmLandingpage','class'=>'form-horizontal','role'=>'form', 'autocomplete'=>'off');
echo form_open('manage/Landingpage/add',$atr2); 
?>
 <div class="form-body">
	...
	<div class="form-group">
		...
		<div class="col-md-10 col-sm-9">
			...
			<a class="btn purple" href="<?php echo base_url('manage/Landingpage/'); ?>">Back</a>
		</div>
	</div><!--End form-group-->
 </div><!--End form-body-->
 <?php form_close(); ?>
...
<script type="text/javascript">
    ...
    $("#frmLandingpage").on('submit', function() {
	...
	jQuery( "#frmLandingpage" ).validate({

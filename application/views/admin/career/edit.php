...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="portlet box blue">
			...
			echo form_open_multipart('manage/Career/edit',$atr2,$hidden); 
		?>
                <div class="form-body">
	    ...
	    ?>
                    ...
                    <div class="form-group clearfix">
                        <label class="col-sm-3 control-label">Job Profile (Hindi) <span class="red">*</span></label>
                        <div class="col-sm-9">
                            <?php 		
	 ...
	 ?>
                    ...
                    <div class="form-group clearfix">
                        <label class="col-sm-3 control-label">Qualification and Experience (Hindi)</label>
                        <div class="col-sm-9">
                            <?php     

              	$EXP_PAGEDESC_HI = (isset($DataList->exp_description_hi) && $DataList->exp_description_hi !='' )?
        html_entity_decode(stripslashes2($DataList->exp_description_hi)):"";
	    ...
	    ?>
                    ...
                    <!--End form-group-->
                    <div class="form-group clearfix">
                        <label class="col-sm-3  control-label">Job Profile (English) <span class="red">*</span></label>
                        <div class="col-sm-9">
                            <?php 		
	  ...
	  ?>
                    ...
                    <div class="form-group clearfix">
                        <label class="col-sm-3 control-label">Qualification and Experience (English)</label>
                        <div class="col-sm-9">
                            <?php     

                	$EXP_PAGEDESC_EN = (isset($DataList->exp_description_en) && $DataList->exp_description_en !='' )?
        html_entity_decode(stripslashes2($DataList->exp_description_en)):"";
	    echo $this->ckeditor->editor('exp_description_en',@$EXP_PAGEDESC_EN);
             ?>
                            <div id="exp_description_en"></div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 ">
                            <p>
                                ...
                                View Uploaded File <a target="_blank"
                                    href="<?php echo base_url('uploads/files/'.$DataList->attachment); ?>"><i
                                        class="fa fa-download"></i></a>
                                <?php endif; ?>


                            </p>
                            <?php echo form_upload(array('name'=>'attachment','id'=>'attachment','accept'=>'image/*,.pdf', 'data-msg-accept'=>'Allow only PDF|pdf|JPEG|jpeg|JPG|jpg|png' )); ?> 
                        <br>
                    ...
                    <div class="form-group clearfix">
                        ...
                        <div class="col-sm-6">
                            <?php $ISSUE_DATE = array('name'=>'issue_date','id'=>'issue_date','class'=>'form-control','value'=>(isset($DataList->issue_date) && !empty(get_date($DataList->issue_date)))? get_date($DataList->issue_date):"");
	    ...
	    ?>
                    ...
                    <div class="form-group clearfix">
                        ...
                        <div class="col-sm-6">
                            <?php $LAST_DATE = array('name'=>'last_date','id'=>'last_date','class'=>'form-control','value'=>(isset($DataList->last_date) && !empty(get_date($DataList->last_date)))? get_date($DataList->last_date):"");
	    ...
	    ?>
                    ...
                    <div class="form-group clearfix hidden">
                        ...
                        <div class="col-sm-9">
                            <input type="checkbox" name="is_new" id="is_new" value="1"
                                <?php echo ($DataList->is_new==1)?"checked":""; ?>>
                        </div>
                    </div>
                    <!--End Form-group-->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 ">
                            <?php
               $STATUS = array(""=>"--Select Status--",'1'=>'Publish','0'=>'Pending');

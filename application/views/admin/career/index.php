...
<div class="row">
  <div class="col-md-12">
    <ul class="page-breadcrumb breadcrumb">
      ...
      <li><a href="<?php echo base_url('manage/Career/'); ?>">Carrer</a><i class="fa fa-angle-right"></i></li>
      ...
      <li class="btn-group">
        ...
        <ul class="dropdown-menu pull-right" role="menu">
          <li><a href="<?php echo base_url('manage/Career/add'); ?>"><i class="fa fa-plus"></i> Add</a></li>
        </ul>
      </li>
    </ul>
...
function searchFilter(page_num) {
	    ...
	    $.ajax({
	        type: 'POST',
	        url: '<?php echo base_url("manage/Career/ajaxPaginationData/"); ?>'+page_num,
	        data:dataString,

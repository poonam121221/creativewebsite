...
<div class="col-md-12">
	<ul class="page-breadcrumb breadcrumb">
		...
		<li><a href="<?php echo base_url('manage/Rti/'); ?>">RTI</a><i class="fa fa-angle-right"></i></li>
		...
		<li><a href="<?php echo base_url('manage/Rti/add'); ?>"><i class="fa fa-plus"></i> Add</a></li>
		</ul>
		</li>
	</ul>
...
<div class="portlet-title">
  <div class="caption">RTI List</div>
...
function searchFilter(page_num,all) {
	    ...
	    $.ajax({
	        type: 'POST',
	        url: '<?php echo base_url("manage/Rti/ajaxPaginationData/"); ?>'+page_num,
	        data:dataString,

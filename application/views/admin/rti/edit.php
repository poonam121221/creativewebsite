...
<div class="portlet-title">
  <div class="caption">Edit Right to Information</div>
...
$atr2 =array('id'=>'frmRulesacts','name'=>'frmRulesacts','class'=>'form-horizontal','role'=>'form', 'autocomplete'=>'off');
echo form_open_multipart('manage/Rti/edit',$atr2,$hidden); 
?>
 <div class="form-body">
 	 ...
 	 <div class="form-group">
		...
		<div class="col-sm-9">
			...
			<a class="btn purple" href="<?php echo base_url('manage/Rti/'); ?>">Back</a>
		</div>
	</div><!--End form-group-->

...
<div class="col-md-12">
	<ul class="page-breadcrumb breadcrumb">
		...
		<li><a href="<?php echo base_url('manage/Hospitalcategory'); ?>">Hospital Category</a><i class="fa fa-angle-right"></i></li>
...
<div class="portlet-title">
  <div class="caption">Edit Hospital Category</div>
...
<?php
$cat_enc_id = html_escape(isset($DataList->cat_id)? encrypt_decrypt('encrypt',$DataList->cat_id):'');
$hidden = array('id' => $cat_enc_id);
$atr2 =array('id'=>'frmCircularCategory','name'=>'frmCircularCategory','class'=>'form-horizontal','role'=>'form', 'autocomplete'=>'off');
echo form_open('manage/Hospitalcategory/edit',$atr2,$hidden); 
?>
 <div class="form-body">

 		<div class="form-group">
		<label class="col-sm-3 control-label">Quick Link</label>
		<div class="col-sm-9">
		<div class="form-control"><?php echo base_url('hospital/'.$cat_enc_id); ?></div>
		</div>
	   </div><!--End form-group-->
 	 ...
 	 <div class="form-group">
		...
		<div class="col-sm-9">
			...
			<a class="btn purple" href="<?php echo base_url('manage/Hospitalcategory/'); ?>">Back</a>
		</div>
	</div><!--End form-group-->
...
<script type="text/javascript">
	...
	jQuery( "#frmCircularCategory" ).validate({
		  rules: { 
		  cat_title_hi: {
		        required: true,
		        minlength:2,

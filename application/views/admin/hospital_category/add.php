...
<div class="portlet-title">
  <div class="caption">Add Hospital Category</div>
...
echo form_open('manage/Hospitalcategory/add',$atr2); 
?>
 <div class="form-body">
 	<div class="form-group">
        ...
        'name'=>'cat_title_hi','id'=>'cat_title_hi','class'=> 'form-control','placeholder'=>'Enter Hospital Category in hindi');
	...
	<div class="form-group">
        ...
        'name'=>'cat_title_en','id'=>'cat_title_en','class'=> 'form-control','placeholder'=>'Enter Hospital Category in english');

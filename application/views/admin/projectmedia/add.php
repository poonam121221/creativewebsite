...
<div class="portlet-body">
	...
	<?php 
		 $atr =array('id'=>'frmuploadpicture','name'=>'frmuploadpicture','role'=>'form', 'autocomplete'=>'off','class'=>'dropzone dropzone-mini dz-clickable');
	   	 echo form_open_multipart('manage/ProjectMedia/insertpic',$atr);
	
	?>
		<div class="col-md-12 clearfix">
			<label class="col-lg-2 col-md-3 control-label">Project  <span class="red">*</span></label>
			<div class="col-lg-5 col-md-6">
			<?php 
				echo form_dropdown(array('name'=>'project_id','id'=>'project_id','class'=>'form-control input-medium project_id'),
			    isset($ProjectList)?$ProjectList:array(''=>'--SELECT Project--'),isset($ProjectList->id) ? ($ProjectList->id):'');
			?>
			</div>	
...
jQuery(document).ready(function(){
	...
	Dropzone.autoDiscover = false;
		...
		jQuery('.project_id').on('change', function(e){

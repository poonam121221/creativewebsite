...
<div class="portlet-title">
  <div class="caption">Edit Project</div>
...
<div class="portlet-body">
	...
	<?php 
		...
		$atr2 =array('id'=>'frmProject','name'=>'frmProject','role'=>'form', 'autocomplete'=>'off');
   		echo form_open_multipart('manage/Project/edit',$atr2,$hidden); 
	?>
	...
	<div class="form-group clearfix">
	 ...
	 <div class="form-group clearfix">
		...
		<div class="col-lg-5 col-md-6">
	        ...
	        'src'   => (isset($DataList->attachment) && trim($DataList->attachment)!="")? 'uploads/project/'.html_escape($DataList->attachment):'webroot/img/no_image.png',
	        'alt'   => 'Project Image',
	        'class' => 'post_images',
	        'width' => '100',
	        'height'=> '100',
	 ...
	 <div class="form-group clearfix">
	    ...
	    <?php $PSTATUS = array(""=>"--Select Status--",'1'=>'Completed','2'=>'In Progress');
	        ...
	        html_escape($DataList->project_status):set_value('status'),array('class'=> 'form-control input-medium'));
		?>
	    </div>
     </div>  
     <?php if($optstatus==1){ ?>

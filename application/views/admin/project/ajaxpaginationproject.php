...
?>
	...
	<tr>
        ...
        'src'   => 'uploads/project/'.html_escape($row->attachment),
        'alt'   => $row->attachment,
        'class' => 'post_images',
        'width' => '100',
        'height'=> '100',
        ...
        <td><?php if($row->project_status == 1){echo 'Completed';}else{echo 'In progress';} ?></td>
	    <td><?php echo PublishStatus(html_escape($row->status));  ?></td>
	    <td>

	    <a href="<?php echo base_url('manage/Project/edit/'.$id.'/'); ?>" class="btn default btn-xs purple tooltips" data-toggle="tooltip" data-placement="top" title="" data-original-title="Update Data">
	    <i class="fa fa-edit"></i></a>
	    <a href="<?php echo base_url('manage/Project/delete/'.$id.'/'); ?>" class="btn default btn-xs red tooltips" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete Data" onclick="return confirm('Are you sure to delete record?'); ">

...
<div class="portlet-title">
  <div class="caption">Important Website List (Recycle)</div>
...
<div class="portlet-body">
  <div class="table-responsive">
	...
	<tr>
	    ...
	    <td>
	    <a href="<?php echo base_url('manage/Importantwebsite/recycle_delete/'.$id.'/1'); ?>" class="btn default btn-xs red tooltips" onclick="return confirm('Are you sure to delete record permanently ?'); " data-placement="top" data-original-title="Permanently Delete">
	    <i class="fa fa-trash-o"></i> Delete</a>
	    <a href="<?php echo base_url('manage/Importantwebsite/recycle_delete/'.$id.'/0'); ?>" class="btn default btn-xs green tooltips" onclick="return confirm('Are you sure to restore this record?'); " data-placement="top" data-original-title="Restore">

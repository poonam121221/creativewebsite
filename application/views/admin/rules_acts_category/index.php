...
<div class="col-md-12">
	<ul class="page-breadcrumb breadcrumb">
		...
		<li><a href="<?php echo base_url('manage/Rulesactscategory/add'); ?>"><i class="fa fa-plus"></i> Add</a></li>
		</ul>
		</li>
	</ul>
...
<div class="portlet-title">
  <div class="caption">Rule & Acts Category List</div>
...
<div class="portlet-body">
  <div class="table-responsive">
	...
	<tr>
	    ...
	    ?>
	    <a href="<?php echo base_url('manage/Rulesactscategory/edit/'.$id.'/'); ?>" class="btn default btn-xs purple tooltips" data-placement="top" data-original-title="Edit">
	    <i class="fa fa-edit"></i></a>
	    <!--<a href="<?php echo base_url('manage/Rulesactscategory/delete/'.$id.'/'); ?>" class="btn default btn-xs red tooltips" onclick="return confirm('Are you sure to delete record?'); " data-placement="top" data-original-title="Delete">

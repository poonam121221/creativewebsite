...
<div class="col-md-12">
	<ul class="page-breadcrumb breadcrumb">
		...
		<li><a href="<?php echo base_url('manage/individual/'); ?>">individual</a><i class="fa fa-angle-right"></i></li>
...
<div class="panel panel-primary">
	...
	<div class="panel-body">
	  ...
	  <div class="row">
	  	...
	  	<?php $TITLE = array('name'=>'title','id'=>'sTitle','class'=> 'form-control','placeholder'=>'Search by name');
...
function searchFilter(page_num,all) {
	    ...
	    var dataString ={'page':page_num,'sTitle':sTitle,'sEmail':sEmail,'sMobile':sMobile,'sStatus':sStatus,"<?php echo $this->security->get_csrf_token_name();?>":tokenVal};
	    
	    $('#ajaxloading').modal('show');
	    
	    $.ajax({
	        type: 'POST',
	        url: '<?php echo base_url("manage/Individual/ajaxPaginationData/"); ?>'+page_num,
	        data:dataString,

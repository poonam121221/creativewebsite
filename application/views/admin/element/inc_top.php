...
<div class="header navbar navbar-fixed-top">
	...
	<div class="header-inner">
		<!-- BEGIN LOGO -->
		<a class="navbar-brand" style="font-weight:bold;" href="<?php echo base_url();?>" target="_blank">
        	<span style="color:#f8ab3e;">EPCO</span> Admin
		   <?php /*?><img src="<?php echo base_url('webroot/img/logo.png');?>" alt="logo" class="img-responsive" /><?php */?>
		</a>
		<!-- END LOGO -->

...
<link rel="manifest"  crossorigin="use-credentials" href="<?php echo HTTP_IMAGES_PATH_ADMIN; ?>/favicon/manifest.json">
...
<link rel="stylesheet" href="<?php echo base_url();?>webroot/fonts/fonts.css"/>

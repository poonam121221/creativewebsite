...
<div class="portlet-title">
  <div class="caption">Finance Report</div>
...
$atr2 =array('id'=>'frmFinancereport','name'=>'frmFinancereport','class'=>'form-horizontal','role'=>'form', 'autocomplete'=>'off');
echo form_open_multipart('manage/Financereport/edit',$atr2,$hidden); 
?>
 <div class="form-body">
	   ...
	   <?php }//end check optstatus ?>
		...
		<div class="col-sm-6">
		<?php $ARCHIVE_DATE = array('name'=>'archive_date','id'=>'archive_date','class'=>'form-control','value'=>(isset($DataList->archive_exp_date) && get_date($DataList->archive_exp_date)) != '' ? get_date($DataList->archive_exp_date):"");
 	 ...
 	 <div class="form-group">
		...
		<div class="col-sm-9">
			...
			<a class="btn purple" href="<?php echo base_url('manage/Financereport/'); ?>">Back</a>
		</div>
	</div><!--End form-group-->
...
<script type="text/javascript">
	...
	$('#archive_date').datepicker({format:'dd-mm-yyyy',autoclose:true,startDate:'-1m'})
	...
	jQuery( "#frmFinancereport" ).validate({
		  rules: { 
		  title_hi: {
		        required: true,
		        minlength:2,

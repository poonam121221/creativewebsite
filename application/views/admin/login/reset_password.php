...
<div class="container">
 <div class="row login-box">
  ...
  <div class="start-form">
	...
	echo form_open('manage/Authuser/reset_password',$atributes);
	$data = array(
        'key' => (isset($key))?$key:'',
	...
	<div class="panel panel-default">
      <div class="panel-heading">Reset Password (Chapter)</div>
       <div class="panel-body">
           
		<h3>Reset Password</h3>
		<p>Enter your password and confirm password below to create your new password.</p>
		...
		<div class="input-icon">
		<input class="form-control input-block-level" type="text" autocomplete="off" placeholder="Enter security code" name="captcha" tabindex="3" autofocus="autofocus"/>
		</div>
		</div>
            ...
            <div class="panel-footer">
              <div class="form-group">
			<button type="submit" class="btn btn-success pull-right" tabindex="4">
			Submit <i class="m-icon-swapright m-icon-white"></i>
			</button>
			<a class="btn btn-primary" href="<?php echo base_url('manage'); ?>" tabindex="5">Back</a>
              </div>

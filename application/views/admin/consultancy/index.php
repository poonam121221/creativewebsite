	...
	<div class="panel-body">
	  ...
	  <div class="row">
	    ...
	    ?>
		  ...
		  <div class="col-sm-3">
		<?php
		echo form_dropdown(array('name'=>'state','id'=>'state_id','class'=>'form-control select2me'),
		isset($StateList)?$StateList:array(''=>'--SELECT STATE--'),'');
		?>
		</div>
		  <div class="col-sm-3 ">
		<?php $STATUS = array(''=>'--Payment Status--','1'=>'Done','0'=>'Pending');
...
<div class="portlet-title">
  <div class="caption">Consultancy List</div>
...
function searchFilter(page_num,all) {
	    ...
	    var dataString ={'page':page_num,'state_id':state_id,'sTitle':sTitle,'sStatus':sStatus,
	    ...
	    $.ajax({
	        type: 'POST',
	        url: '<?php echo base_url("manage/Consultancy/ajaxPaginationData/"); ?>'+page_num,
	        data:dataString,

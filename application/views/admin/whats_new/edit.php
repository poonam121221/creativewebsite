...
<div class="portlet-title">
  <div class="caption">Edit What's New</div>
...
$atr2 =array('id'=>'frmWhatsnew','name'=>'frmWhatsnew','class'=>'form-horizontal','role'=>'form', 'autocomplete'=>'off');
echo form_open_multipart('manage/Whatsnew/edit',$atr2,$hidden); 
?>
 <div class="form-body">
 	 ...
 	 <div class="form-group">
		...
		<div class="col-sm-9">
			...
			<a class="btn purple" href="<?php echo base_url('manage/Whatsnew/'); ?>">Back</a>
		</div>
	</div><!--End form-group-->
...
<script type="text/javascript">
	...
	}, $.validator.format("Uploaded file size should be less than or equal to 15 MB)."));
	...
	jQuery( "#frmWhatsnew" ).validate({
		  ...
		  message:{
		  	attachment: {extension:"Please upload only JPEG,JPG,PDF Formet",filesize:"File size must be less than 15 MB"}
		  }
		});	
	});
</script>
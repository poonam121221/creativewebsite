...
?>
	...
	<tr>
		<td><?php echo $i; ?></td>
		<td><?php echo html_escape($row->agency_name); ?></td>
		<td><?php echo html_escape($row->agency_type_name); ?></td>
	    ...
	    <a href="<?php echo base_url('manage/Implementuser/show/'.$id.'/'); ?>" class="btn default btn-xs blue tooltips" data-placement="top" data-original-title="Agency Title">

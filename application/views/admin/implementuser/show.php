...
<div class="portlet-title">
  <div class="caption">Update Implementing Partner Status</div>
...
<!--End Validation message-->
 <!--------------------------------------------------------------------->
  ...
  echo form_open('manage/Implementuser/update_status',$atr2,$hidden); 
  ?>
   ...
   <div class="col-sm-12"> 
    ...
    <div class="row">
     <div class="col-sm-12">
			...
			<a class="btn purple" tabindex="20" href="<?php echo base_url('manage/Implementuser/'); ?>">Back</a>
	</div>
  </div><!--End row-->
...
<h3 class="form-section">Implementing Partner Details (कार्यान्वयन साथी का विवरण)</h3>
  ...
  <div class="row" style="    margin-bottom: 20px;">
	...
	</div><!--End row agency Information-->
...
<div class="row">		
 <div class="col-md-12">
  ...
  <div class="we-control">
   <?php if($DataList->is_agency_fcra_registered==1 && trim($DataList->fcra_reg_attachment)!=""): ?>

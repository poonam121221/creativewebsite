...
<div class="portlet-title">
  <div class="caption">Edit Publication Category</div>
...
echo form_open('manage/Publicationcategory/edit',$atr2,$hidden); 
?>
 <div class="form-body">
 	 ...
 	 <div class="form-group">
		...
		<div class="col-sm-9">
			...
			<a class="btn purple" href="<?php echo base_url('manage/Publicationcategory/'); ?>">Back</a>
		</div>
	</div><!--End form-group-->

...
<div class="col-md-12">
	<ul class="page-breadcrumb breadcrumb">
		...
		<li><a href="<?php echo base_url('manage/Noticeboard/add'); ?>"><i class="fa fa-plus"></i> Add</a></li>
		</ul>
		</li>
	</ul>
...
<div class="portlet-title">
  <div class="caption">Notice Board List</div>
...
function searchFilter(page_num,all) {
	    ...
	    $.ajax({
	        type: 'POST',
	        url: '<?php echo base_url("manage/Noticeboard/ajaxPaginationData/"); ?>'+page_num,
	        data:dataString,

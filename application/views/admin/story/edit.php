...
<div class="col-md-12">
	<ul class="page-breadcrumb breadcrumb">
		...
		<li><a href="<?php echo base_url('manage/Story/'); ?>">Story</a><i class="fa fa-angle-right"></i></li>
...
<div class="portlet-title">
  <div class="caption">Edit Story</div>
...
$atr2 =array('id'=>'frmStory','name'=>'frmStory','class'=>'form-horizontal','role'=>'form', 'autocomplete'=>'off');
echo form_open_multipart('manage/Story/edit',$atr2,$hidden); 
?>
 <div class="form-body">
	 ...
	 <div id="description_en1"></div>
	   ...
	   <div class="form-group">
		<label class="col-md-2 col-sm-3 control-label">Attachment </label>
		<div class="col-md-10 col-sm-9 ">
		<p>
	   ...
	   <div class="form-group clearfix">
		...
		<div class="col-md-10 col-sm-9">
		<?php $ARCHIVE_DATE = array('name'=>'archive_date','id'=>'archive_date','class'=>'form-control input-medium','value'=>(isset($DataList->archive_exp_date) && !empty($DataList->archive_exp_date))? get_date($DataList->archive_exp_date):"");
 	 ...
 	 <div class="form-group">
		...
		<div class="col-md-10 col-sm-9">
			...
			<a class="btn purple" href="<?php echo base_url('manage/Story/'); ?>">Back</a>
		</div>
	</div><!--End form-group-->

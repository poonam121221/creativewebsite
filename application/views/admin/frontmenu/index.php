...
<div class="col-md-12">
	<ul class="page-breadcrumb breadcrumb">
		...
		<li><a href="<?php echo base_url('manage/Frontmenu/'); ?>">Front Menu</a><i class="fa fa-angle-right"></i></li>
...
<div class="portlet-title">
  <div class="caption">Front Top Menu List</div>
...
<div class="row">
	<div class="col-sm-12">
	    <menu id="nestable-menu">
	      ...
	      <a class="btn green" href="<?php echo base_url('manage/Frontmenu/bottomMenu/'); ?>"><i class="fa fa-hand-o-right"></i> Bottom Menu View</a>
	    </menu>
	</div><!--End column-->
</div><!--End row-->

...
<div class="portlet-title">
  <div class="caption">Contact Board</div>
...
echo form_open_multipart('manage/Contactboard/edit',$atr2,$hidden); 
?>
  <div class="form-body">
 	...
 	<div class="form-group">
		...
		echo form_dropdown('type', $OPTIONS, (isset($DataList->type) && $DataList->type !='' )?
         html_escape($DataList->type):'',array('class'=> 'form-control input-medium'));
	    ?>
		</div>
	</div><!--End form-group-->
	...
	<div class="form-group">
		...
		<div class="col-sm-8 col-md-9">
		<?php 
		 echo form_dropdown(array('name'=>'d_id','id'=>'d_id','class'=>'form-control input-medium'),
		 isset($DesignationList)?$DesignationList:array(''=>'--SELECT DESIGNATION--'),isset($DataList->d_id) ? ($DataList->d_id):'');
		?>
		</div>
	</div><!--End form-group-->
    <div class="form-group">
	...
	<div class="form-group">
		<label class="col-sm-4 col-md-3 control-label">Image </label>
	...
	<div class="form-group">
        ...
        'src'   => (isset($DataList->attachment) && trim($DataList->attachment)!="")? 'uploads/files/'.html_escape($DataList->attachment):'webroot/img/no_image.png',

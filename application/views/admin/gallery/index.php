...
<div class="col-md-12">
	<ul class="page-breadcrumb breadcrumb">
		...
		<li><a href="<?php echo base_url('manage/Gallerymaster/add'); ?>"><i class="fa fa-plus"></i> Add</a></li>
		</ul>
		</li>
	</ul>
...
<div class="portlet-title">
  <div class="caption">Photo Gallery List</div>
...
function searchFilter(page_num,all) {
	    ...
	    var dataString ={'page':page_num,'c_id':c_id,'sTitle':sTitle,'sStatus':sStatus,'sortBy':sortBy,
	    ...
	    $.ajax({
	        type: 'POST',
	        url: '<?php echo base_url("manage/Gallerymaster/ajaxPaginationData/"); ?>'+page_num,
	        data:dataString,

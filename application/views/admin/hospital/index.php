...
<div class="col-md-12">
	<ul class="page-breadcrumb breadcrumb">
		...
		<li><a href="<?php echo base_url('manage/Hospital/add'); ?>"><i class="fa fa-plus"></i> Add</a></li>
		</ul>
		</li>
	</ul>
...
<div class="panel panel-primary">
	...
	<div class="panel-body">
	  ...
	  <div class="row">
	   <div class="col-sm-3">
		<?php
		echo form_dropdown(array('name'=>'category','id'=>'c_id','class'=>'form-control'),
		isset($CategoryList)?$CategoryList:array(''=>'--SELECT TYPE--'),isset($DataList->dept_id) ? ($DataList->dept_id):'');
		?>
		</div>
	  	<div class="col-sm-3">
	  	<?php $TITLE = array('name'=>'title','id'=>'sTitle','class'=> 'form-control','placeholder'=>'Search by Hospital Name');
		echo form_input($TITLE);
	    ?>
	  	</div>
		<div class="col-sm-3">
		<?php $STATUS = array(''=>'--Status--','1'=>'Publish','0'=>'Pending');
...
<div class="portlet-title">
  <div class="caption">Hospital List</div>
...
function searchFilter(page_num,all) {
	    ...
	    var dataString ={'page':page_num,'c_id':c_id,'sTitle':sTitle,'sStatus':sStatus,
	    ...
	    $.ajax({
	        type: 'POST',
	        url: '<?php echo base_url("manage/Hospital/ajaxPaginationData/"); ?>'+page_num,
	        data:dataString,

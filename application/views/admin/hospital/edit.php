...
<div class="col-md-12">
	<ul class="page-breadcrumb breadcrumb">
		...
		<li><a href="<?php echo base_url('manage/Hospital/'); ?>">View</a></li>
	</ul>
...
<div class="portlet-title">
  <div class="caption">Edit Hospital</div>
...
echo form_open_multipart('manage/Hospital/edit',$atr2,$hidden); 
?>
 <div class="form-body">
		...
		?>
 		...
 		<div class="form-group">
		<label class="col-sm-3 col-md-2 control-label">Hopital Name (Hindi) <span class="red">*</span></label>
		<div class="col-sm-9 col-md-10">
		<?php $TITLE_HI = array( 
        'name'=>'title_hi','id'=>'title_hi','class'=> 'form-control','placeholder'=>'Enter hopital name in hindi',
	   ...
	   <div class="form-group">
		<label class="col-sm-3 col-md-2 control-label">Hopital Name (English) <span class="red">*</span></label>
		<div class="col-sm-9 col-md-10">
		<?php $TITLE_EN = array( 
        'name'=>'title_en','id'=>'title_en','class'=> 'form-control','placeholder'=>'Enter hopital name in hindi',
...
<script type="text/javascript">
	...
	jQuery( "#frmHospital" ).validate({
		  ...
		  messages:{
		  	attachment: {extension:"Please upload only JPEG,JPG,PNG Formet",filesize:"File size must be less than 25 MB"}
		  }
		});	

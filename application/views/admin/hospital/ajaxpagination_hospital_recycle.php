 ...
 <table class="table table-striped table-bordered table-hover dataTable">
	...
	<tr>
	    ...
	    <td>
	    <a href="<?php echo base_url('manage/Hospital/recycle_delete/'.$id.'/1'); ?>" class="btn default btn-xs red tooltips" onclick="return confirm('Are you sure to delete record permanently ?'); " data-placement="top" data-original-title="Permanently Delete">
	    <i class="fa fa-trash-o"></i> Permanently Delete</a>
	    <a href="<?php echo base_url('manage/Hospital/recycle_delete/'.$id.'/0'); ?>" class="btn default btn-xs green tooltips" onclick="return confirm('Are you sure to restore this record?'); " data-placement="top" data-original-title="Restore">

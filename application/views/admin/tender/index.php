    ...
    <ul class="page-breadcrumb breadcrumb">
      ...
      <li class="btn-group">
        ...
        <ul class="dropdown-menu pull-right" role="menu">
          <li><a href="<?php echo base_url('manage/Tender/add'); ?>"><i class="fa fa-plus"></i> Add</a></li>
        </ul>
      </li>
    </ul>
...
function searchFilter(page_num) {
	    ...
	    $.ajax({
	        type: 'POST',
	        url: '<?php echo base_url("manage/Tender/ajaxPaginationData/"); ?>'+page_num,
	        data:dataString,

...
<div class="portlet-title">
  <div class="caption">Update Testimonial</div>
...
echo form_open_multipart('manage/Testimonial/edit',$atr2,$hidden); 
?>
  <div class="form-body">
	...
	<div class="form-group">
        ...
        'value' => (isset($DataList->description_hi) && $DataList->description_hi!='' )?
         html_escape($DataList->description_hi):set_value('description_hi'));
	...
	<div class="form-group">
        ...
        'name'=>'description_en','class'=> 'form-control','placeholder'=>'Enter message english',
        'value' => (isset($DataList->description_en) && $DataList->description_en!='' )?
         html_escape($DataList->description_en):set_value('description_en'));

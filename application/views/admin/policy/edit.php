...
echo form_open_multipart('manage/Policy/edit',$atr2,$hidden); 
?>
  <div class="form-body">
	...
	<div class="form-group">
	    ...
	    View Uploaded File <a target="_blank" href="<?php echo base_url('uploads/policy/'.$DataList->attachment); ?>"><i class="fa fa-download"></i></a>
	    <?php endif; ?></p>
	...
	<div class="form-group clearfix">
		<label class="col-sm-4 col-md-3 control-label">Archive Date <span class="red">*</span></label>
		<div class="col-sm-8 col-md-9">
...
<script type="text/javascript">
	jQuery(function(){	
		...
		}, jQuery.validator.format("Uploaded file size should be less than or equal to 2 mb)."));

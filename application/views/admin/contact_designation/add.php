...
<div class="portlet-title">
  <div class="caption">Add Contact Designation</div>
...
echo form_open('manage/Contactdesignation/add',$atr2); 
?>
 <div class="form-body">
 	...
 	<div class="form-group">
        ...
        'name'=>'designation_hi','id'=>'designation_hi','class'=> 'form-control','placeholder'=>'Enter Contact Designation in hindi');
	...
	<div class="form-group">
        ...
        'name'=>'designation_en','id'=>'designation_en','class'=> 'form-control','placeholder'=>'Enter Contact Designation in english');

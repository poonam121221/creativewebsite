...
<div class="col-md-12">
	<ul class="page-breadcrumb breadcrumb">
		...
		<li><a href="<?php echo base_url('manage/Circularcategorymaster'); ?>">Circular Category</a><i class="fa fa-angle-right"></i></li>
...
<div class="portlet-title">
  <div class="caption">Add Circular Category</div>
...
echo form_open('manage/Circularcategorymaster/add',$atr2); 
?>
 <div class="form-body">
 	<div class="form-group">
        ...
        'name'=>'cat_title_hi','id'=>'cat_title_hi','class'=> 'form-control','placeholder'=>'Enter Circular Category in hindi');
	...
	<div class="form-group">
        ...
        'name'=>'cat_title_en','id'=>'cat_title_en','class'=> 'form-control','placeholder'=>'Enter Circular Category in english');
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			...
			<a class="btn purple" href="<?php echo base_url('manage/Circularcategorymaster/'); ?>">Back</a>
		</div>
	</div><!--End form-group-->
 </div><!--End form-body-->
 <?php form_close(); ?>

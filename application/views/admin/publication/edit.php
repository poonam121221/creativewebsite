...
<div class="portlet-title">
  <div class="caption">Edit Publication</div>
...
$atr2 =array('id'=>'frmPublication','name'=>'frmPublication','class'=>'form-horizontal','role'=>'form', 'autocomplete'=>'off');
echo form_open_multipart('manage/Publication/edit',$atr2,$hidden); 
?>
 <div class="form-body">

 	<div class="form-group clearfix">
		<label class="col-lg-3 col-md-3 control-label">Category<span class="red">*</span></label>
 	 ...
 	 <div class="form-group">
		...
		<div class="col-sm-9">
			...
			<a class="btn purple" href="<?php echo base_url('manage/Publication/'); ?>">Back</a>
		</div>
	</div><!--End form-group-->
...
<script type="text/javascript">
    ...
    jQuery("#frmPublication").submit(function(){
	 if(jQuery( "#frmPublication" ).valid()==true){
	 	jQuery('#ajaxloading').modal('show');
	 }      
    });
	...
	jQuery( "#frmPublication" ).validate({
		  rules: { 
		  cat_id:{
		  		required: true,
		  		digits:true
		  ...
		  title_hi: {
		   ...
		   title_en: {
			...
			attachment:{
				...
				filesize:52428800 //1024*1024*25
			},
            archive_date: {
				required: true,
				checkdate:true

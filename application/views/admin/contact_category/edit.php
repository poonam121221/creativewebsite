...
<div class="portlet-title">
  <div class="caption">Edit Contact Category</div>
...
echo form_open('manage/Contactcategory/edit',$atr2,$hidden); 
?>
 <div class="form-body">
        ...
        'name'=>'category_hi','id'=>'category_hi','class'=> 'form-control','placeholder'=>'Enter Category Name in hindi',
        'value' => (isset($DataList->category_hi) && $DataList->category_hi !='' )?
         html_escape($DataList->category_hi):set_value('category_hi'));
	   ...
	   <div class="form-group">
        ...
        'name'=>'category_en','id'=>'category_en','class'=> 'form-control','placeholder'=>'Enter Category Name in english',
        'value' => (isset($DataList->category_en) && $DataList->category_en !='' )?
         html_escape($DataList->category_en):set_value('category_en'));

...
<div class="portlet-title">
  <div class="caption">FAQ Category List</div>
...
<div class="portlet-body">
  <div class="table-responsive">
	...
	<tr>
	    ...
	    <td>
	    <a href="<?php echo base_url('manage/Faqcategory/edit/'.$id.'/'); ?>" class="btn default btn-xs purple tooltips" data-placement="top" data-original-title="Edit">
	    <i class="fa fa-edit"></i></a>
	    <a href="<?php echo base_url('manage/Faqcategory/delete/'.$id.'/'); ?>" class="btn default btn-xs red tooltips" onclick="return confirm('Are you sure to delete record?'); " data-placement="top" data-original-title="Delete">

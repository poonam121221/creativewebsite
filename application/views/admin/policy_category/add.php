...
<div class="portlet-title">
  <div class="caption">Add Policy Category</div>
...
echo form_open('manage/Policycategory/add',$atr2); 
?>
 <div class="form-body">
 	<div class="form-group">
        ...
        'name'=>'policies_category_title_hi','id'=>'policies_category_title_hi','class'=> 'form-control','placeholder'=>'Enter Policy Category in hindi');
	...
	<div class="form-group">
        ...
        'name'=>'policies_category_title_en','id'=>'policies_category_title_en','class'=> 'form-control','placeholder'=>'Enter Policy Category in english');

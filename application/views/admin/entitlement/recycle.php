...
<div class="portlet-title">
  <div class="caption">Entitlement List (Recycle)</div>
  ...
  <div class="table-responsive">
	...
	<tr>
	   ...
	   <td><?php echo html_escape($row['edited_name']); ?></td>
	    ...
	    <td>
	    <a href="<?php echo base_url('manage/Entitlement/recycle_delete/'.$id.'/1'); ?>" class="btn default btn-xs red tooltips" onclick="return confirm('Are you sure to delete record permanently ?'); " data-placement="top" data-original-title="Permanently Delete">
	    <i class="fa fa-trash-o"></i> Delete</a>
	    <a href="<?php echo base_url('manage/Entitlement/recycle_delete/'.$id.'/0'); ?>" class="btn default btn-xs green tooltips" onclick="return confirm('Are you sure to restore this record?'); " data-placement="top" data-original-title="Restore">

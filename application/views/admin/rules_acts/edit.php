...
<div class="portlet-title">
  <div class="caption">Edit Rules , Acts & Laws</div>
...
echo form_open_multipart('manage/Rulesacts/edit',$atr2,$hidden); 
?>
 <div class="form-body">
 	 ...
 	 <div class="form-group">
		...
		<div class="col-sm-9">
			...
			<a class="btn purple" href="<?php echo base_url('manage/Rulesacts/'); ?>">Back</a>
		</div>
	</div><!--End form-group-->

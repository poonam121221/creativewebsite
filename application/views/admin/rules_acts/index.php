...
<div class="col-md-12">
	<ul class="page-breadcrumb breadcrumb">
		...
		<li><a href="<?php echo base_url('manage/Rulesacts/'); ?>">Rules , Acts & Laws</a><i class="fa fa-angle-right"></i></li>
		...
		<li><a href="<?php echo base_url('manage/Rulesacts/add'); ?>"><i class="fa fa-plus"></i> Add</a></li>
		</ul>
		</li>
	</ul>
...
<div class="panel panel-primary">
	...
	<div class="panel-body">
	  ...
	  <div class="row">
	    <div class="col-sm-4">
		<?php 
			echo form_dropdown(array('name'=>'cat_id','id'=>'cat_id','class'=>'form-control'),
	  ...
	  <div class="row">
		...
		echo form_dropdown('status', $STATUS, (isset($DataList->status) && $DataList->status !='' )?
         html_escape($DataList->status):set_value('status'),array('class'=> 'form-control', 'id'=>'sStatus','onchange'=>"searchFilter()"));
	    ?>
		</div>
		<div class="col-sm-4">
...
<div class="portlet-title">
  <div class="caption">Rules , Acts & Laws List</div>
...
function searchFilter(page_num) {
	    ...
	    var sCatId  = $("#cat_id option:selected").val();
	    var sStatus = $("#sStatus option:selected").val();        
	    var sortBy  = $('#sortBy option:selected').val();
	    var dataString ={'page':page_num,'sTitle':sTitle,'sStatus':sStatus,'sortBy':sortBy,'sCatId':sCatId,
	    ...
	    $.ajax({
	        type: 'POST',
	        url: '<?php echo base_url("manage/Rulesacts/ajaxPaginationData/"); ?>'+page_num,
	        data:dataString,
